	...
	var retro = {
		...
		, poderes: {
			mostrar: {
				...
				, pedido: bajar.poderes.mostrar.pedido || false
				, recurso: bajar.poderes.mostrar.recurso || false
				, respuesta: {
					cabezas: {
						$: bajar.poderes.mostrar.respuesta.cabezas.$ || true
						, post: {
							longitud: bajar.poderes.mostrar.respuesta.cabezas.post.lognitud || true
							, tipo: bajar.poderes.mostrar.respuesta.cabezas.post.tipo || true
						}
					}
					, estado: bajar.poderes.mostrar.respuesta.estado || true
